...
const areArraysEqual = function(list1, list2) {
  ...
  return areArraysEqual(list1.slice(1), list2.slice(1)); 
}
...
const assertArrayEqual = function(expected, actual, testName) {
  showTestResult(areArraysEqual(actual, expected), expected, actual, testName);
}

const assertObjectEqual = function(expected, actual, testName) {
  showTestResult(areObjectsEqual(actual, expected), expected, actual, testName);
}
